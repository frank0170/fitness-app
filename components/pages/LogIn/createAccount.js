        ...
        <View style={{backgroundColor:'#111214', height:'100%'}}>
            <View style={{flexDirection:'column', height:'100%'}}>
                <View style={{flexDirection:"row", top:"5%"}}>
                    ...
                    <Text style={{fontSize:"16px", fontWeight:"500", color:"#FFFFFF", left:"30%", alignSelf:"center"}}>Create an Account</Text>
                </View>

                <TouchableOpacity style={[LogInStyles.greyBox, {top:'12%'}]}> <Image source={appleIcon} style={{left:'21%', alignSelf:'center',height:'18px', width:'18px'}}/>
                    <Text style={{color:'#FFFFFF', alignSelf:'center',left:'26%', fontSize:'18px', fontWeight:'500'}}>Sign up with Apple</Text></TouchableOpacity>
        
                <TouchableOpacity style={[LogInStyles.greyBox, {top:'10%'}]}> <Image source={googleIcon} style={{left:'21%', alignSelf:'center',height:'18px', width:'18px'}}/>
