...
const EditProfile = () => {
    return (
        <ScrollView style={{backgroundColor:"#111214", height:"100%"}}>
            ...
            <Text style={{fontSize:16, fontWeight:500, color:"#FFFFFF", left:"8%", top:"-10%"}}>First Name</Text>
            <View style={[ProfileStyles.greyBox, {top:"-12%"}]}>
                <ProfileGrey/>
            </View>

            <Text style={{fontSize:16, fontWeight:500, color:"#FFFFFF", left:"8%", top:"-11%"}}>Last Name</Text>
            <View style={[ProfileStyles.greyBox, {top:"-13%"}]}>
                <ProfileGrey/>
            </View>

            <Text style={{fontSize:16, fontWeight:500, color:"#FFFFFF", left:"8%", top:"-12%"}}>Email address</Text>
            ...
            <View style={{flexDirection:"row", top:"-13%"}}>
                <View style={{width:"50%"}}>
                    ...
                    <TouchableOpacity style={[ProfileStyles.greyBox, {top:"-10%", width:"70%"}]}>
                        <WeightGrey/>
                    </TouchableOpacity>
                </View>
            ...
            <Text style={{fontSize:16, fontWeight:500, color:"#FFFFFF", left:"8%", top:"-13%"}}>Date of birth</Text>
            <View style={[ProfileStyles.greyBox, {top:"-15%"}]}>
                <CalendarGrey/>
            </View>
        
            <Text style={{fontSize:16, fontWeight:500, color:"#FFFFFF", left:"8%", top:"-14%"}}>Gender</Text>
            <View style={{flexDirection:"row", top:"-13%"}}>
                <TouchableOpacity style={[ProfileStyles.greyBox, {width:"35%", top:"-30%"}]}>
                    <FilledCircle/>
                    <Text style={{color:"#FFFFFF", fontSize:18, fontWeight:400, left:"25%"}}>Male</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[ProfileStyles.greyBox, {width:"35%", top:"-30%", left:"3%"}]}>
                    <EmptyCircle/>
                    <Text style={{color:"#FFFFFF", fontSize:18, fontWeight:400, left:"25%"}}>Female</Text>
                </TouchableOpacity>
            </View>

            <TouchableOpacity style={[ProfileStyles.whiteBox, {width:"70%", height:50, left:"15%", top:"-14%", flexDirection:"row", alignItems:"center"}]}>
                <View style={{left:"30%"}}>
                    <LogOutIcon/>
                </View>
                <Text style={{color:"#111214", fontSize:14, fontWeight:600, left:"35%"}}>Save Changes</Text>
            </TouchableOpacity>
        </ScrollView>
    )
}
