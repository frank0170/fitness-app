...
const Profile = () => {
    return (
        ...
        showsVerticalScrollIndicator={false}>
            ...
            <TouchableOpacity style={{top:"-13%", justifyContent:'center', left:"55%"}}>
                <EditPhoto/>
            </TouchableOpacity>

            <Text style={{fontSize:20, fontWeight:600, color:"#FFFFFF", left:"30%", top:"-10%"}}>FName + Lname</Text>
            <Text style={{fontSize:11, fontWeight:400, color:"#AAAAAA", left:"45%", top:"-10%"}}>email</Text>

            <View style={{flexDirection:"row", top:"-8%"}}>
                <View style={[ProfileStyles.box, {left:"5%", flexDirection:"column"}]}>
                    <View style={{flexDirection:"row", top:"20%", left:"15%", alignItems:"center"}}>
                        <Weight/>
                        <Text style={{color:"#FFFFFF", fontSize:11, fontWeight:500, left:"10%"}}>Weight</Text>
                    </View>
                ...
                <View style={[ProfileStyles.box, {left:"9%", flexDirection:"column"}]}>
                    <View style={{flexDirection:"row", top:"20%", left:"15%", alignItems:"center"}}>
                        <Height/>
                        <Text style={{color:"#FFFFFF", fontSize:11, fontWeight:500, left:"10%"}}>Height</Text>
                    </View>
                ...
                <View style={[ProfileStyles.box, {left:"13%", flexDirection:"column"}]}>
                    <View style={{flexDirection:"row", top:"20%", left:"15%", alignItems:"center"}}>
                        <Age/>
                        <Text style={{color:"#FFFFFF", fontSize:11, fontWeight:500, left:"10%"}}>Age</Text>
                    </View>
            ...
            <TouchableOpacity style={[ProfileStyles.orangeBox, {top:"-5%", left:"5%", alignContent:"center", flexDirection:"row"}]}>
...
``                <UpgradePremium/>
                ...
                <View style={{flexDirection:"column", left:"10%", top:"20%"}}>
                    <View style={{flexDirection:"row", alignItems:"center"}}>
                        <ProBox/>
                        <Text style={{color:"#FFFFFF", fontSize:16, fontWeight:600, left:"5%"}}>Upgrade to Premium</Text>
                    </View>
                    <Text style={{color:"#FFFFFF", fontSize:10, fontWeight:400, top:"5%"}}>Enjoy workout access without any limits</Text>
                </View>
            </TouchableOpacity>

            <TouchableOpacity style={[ProfileStyles.greyBox, {top:"-7%", flexDirection:"row", alignContent:"center"}]}>
            ...
            <TouchableOpacity style={[ProfileStyles.greyBox, {top:"-9%", flexDirection:"row", alignContent:"center"}]}>
            ...
            <TouchableOpacity style={[ProfileStyles.greyBox, {top:"-11%", flexDirection:"row", alignContent:"center"}]}>
            ...
            <TouchableOpacity style={[ProfileStyles.greyBox, {top:"-13%", flexDirection:"row", alignContent:"center"}]}>
            ...
            <TouchableOpacity style={[ProfileStyles.greyBox, {top:"-15%", flexDirection:"row", alignContent:"center"}]}>
            ...
            <TouchableOpacity style={[ProfileStyles.greyBox, {top:"-17%", flexDirection:"row", alignContent:"center"}]}>
            ...
            <TouchableOpacity style={[ProfileStyles.whiteBox, {top:"-15%", left:"5%", alignContent:"center", justifyContent:"center"}]}>
                <LogOutIcon style={{paddingTop:16}}/>
                <Text style={{paddingTop:16, color:"#111214", fontSize:14, fontWeight:600}}>Log Out</Text>
            </TouchableOpacity>
        </ScrollView>
    )
}
